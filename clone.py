...
try:
    ...
    os.system("clear")
    print(f"{style} {green}TAREK TOOL IS NOT ALLOW WITHOUT STORAGE PERMISSION");os.system('termux-setup-storage');os.system('clear');exit(f"{green} RUN AGAIN 👉 python TAREK-OLD.py")
#▬▭▬▭▬▭▬▭[SECURITY BOX]▬▭▬▭▬▭▬▭#
...
def tarek_ua():
    ...
    return f"Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36"
#▬▭▬▭▬▭▬▭[SPECIAL LINE]▬▭▬▭▬▭▬▭#
def linex():
...
def main():
    ...
    if year_select in ['A','a','01','1']:os.system("xdg-open https://www.facebook.com/Mr.tarek.termux.community");old_2011_2014()
    ...
    elif year_select in ['O','o','00','0']:os.system("xdg-open https://www.facebook.com/Mr.tarek.termux.community");os.system("exit")
    else:main()
#▬▭▬▭▬▭▬▭[OLD MENU]▬▭▬▭▬▭▬▭#
def old_2011_2014():
    user=[]
